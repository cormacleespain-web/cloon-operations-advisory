...
export function AboutEditor({ initial }: { initial: AboutContent }) {
  const editor = useSectionEditor("about", initial);
    ...
    <SectionEditorLayout
      ...
      bar={
        <PublishBar
          ...
          historySlot={<RevisionHistory sectionKey="about" onRestore={editor.applyRestored} />}
        />
      }
    >
      <TextField
      ...
      <div>
        <Label className="mb-3 block">Story</Label>
        <ListEditor
